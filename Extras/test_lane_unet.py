...
TRAIN_PATH = 'D:/Deep_Learning/AI plays gta/test_lane_dataset/train/'
TEST_PATH = 'D:/Deep_Learning/AI plays gta/test_lane_dataset/test/'
...
# Model CheckPoint
checkpointer = tf.keras.callbacks.ModelCheckpoint('model_for_gta.h5', verbose=1, save_best_only=True)
callbacks = [
